...
function getDrinkByProfession(param){
    const lCase = param.toLowerCase();
     switch(lCase) {
        case 'jabroni':
            return 'Patro Tequila';
...
console.log(getDrinkByProfession("jabrOni"), '->', 'Patro Tequila');
console.log(getDrinkByProfession("scHOOl counselor"), '->', 'Anythng with alcohol');
